...
- The implemented client offers **Message Logistics** on an eligible active offered/accepted task. Seller/Buyer threads remain read-only in this rollout. Enable **Message Seller** after first-mile acceptance and **Message Buyer** after final-mile acceptance only when the client and counterpart screens have been adopted and verified under the chat spec. Laravel rechecks eligibility on every call.
