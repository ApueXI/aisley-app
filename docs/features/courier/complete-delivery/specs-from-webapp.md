...
version: 1.4
status: Historical comparison snapshot; superseded by specs.md
...
> Comparison artifact only: use `specs.md` in this folder. Do not implement from this snapshot or treat its checklist as current verification.
