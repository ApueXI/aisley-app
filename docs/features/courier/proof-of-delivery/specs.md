...
flutter_status: QR, Code 128 tracking-ID, and Order-reference proof input plus shared Android/web-server camera candidate capture implemented; physical camera acceptance pending
canonical: true
