...
version: 1.3
status: Backend-defined; physical transitions require approved decisions and migrations
roles: Customer, Seller, Logistics, Courier
scope: Shared order-to-delivery vocabulary and backend contract
authority: backend_canonical_reference
file_state: copied_read_only
canonical_source: docs/features/shared/shipment-fulfillment/spec.md
