...
- Laravel implements Auth/account APIs, first-mile tasks and route manifests, and final-mile tasks, QR evidence, movement, completion, and history. The Flutter owning screens are verified in this project; dashboard aggregation remains unavailable.
...
- Future work sections must identify first-mile Seller pickup or final-mile sole-hub work and its task leg explicitly.
