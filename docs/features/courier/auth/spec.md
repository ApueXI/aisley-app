...
source_coverage: domain/Courier.md, domain/Logistics.md, requirements.md, workspace.md, schema.md
...
- Before adding pickup or delivery actions, reconcile the canonical `docs/workspace.md`, `docs/schema.md`, `docs/domain/Courier.md`, `docs/domain/Logistics.md`, and the affected Courier/Logistics specs. Keep first-mile and final-mile assignments independent and preserve the sole-hub boundary. The decision worksheet is optional background only and is not an implementation dependency.
...
**References:** `docs/requirements.md`, `docs/workspace.md`, `docs/schema.md`, `docs/domain/Courier.md`, `docs/domain/Logistics.md`, `docs/references/user-registration-requirements.md`, [`docs/references/file-upload-requirements.md`](../../../references/file-upload-requirements.md), [Laravel Sanctum token abilities](https://laravel.com/docs/sanctum#token-abilities), and [Laravel authentication](https://laravel.com/docs/authentication).
