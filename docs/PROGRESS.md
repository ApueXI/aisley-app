...
- **Deferred:** Dashboard operational aggregation, physical camera acceptance on installed targets, photo/signature proof media, route/location telemetry, chat, earnings, notification transport, and offline synchronization APIs.
