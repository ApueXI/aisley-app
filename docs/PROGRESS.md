...
- Updated the Linux runner to show its GTK window immediately and opt out of Impeller, avoiding an unmapped window when the renderer produces no first frame under Sway.
