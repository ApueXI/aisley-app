...
> **Flutter use:** This is a shared backend/product contract, not a list of implemented Flutter screens. Read the Courier and shared order/auth sections only. The current Courier implementation boundary is recorded in `docs/features/courier/auth/spec.md` and `docs/features/courier/README.md`.
